                  ...
                  <div className="flex flex-col sm:flex-row gap-12 items-center justify-between">
                      ...
                      <div className="w-full sm:w-1/2 lg:w-2/3 dark:font-extralight font-medium border border-slate-500 p-4 md:p-8 rounded-lg">
                          ...
                          <p className="pt-2 text-sm">
                              I built this because I wasn't very satisfied with
                              the free spelltracking options online and wanted
                              to customize the layout. I'm using the{' '}
                              <Link
                                  href="https://www.dnd5eapi.co/"
                                  className="underline hover:no-underline">
                                  D&D 5e API
                              </Link>
                              , which works pretty well for my needs but is
                              missing some spells from various sources that our
                              table is using. So I have some hard-coded spells
                              as well. I'm utilizing local storage to reduce the
                              number of requests.
                          </p>
                      </div>
                  </div>

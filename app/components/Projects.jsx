...
export default function Projects() {
  return (
    <section className='mx-auto px-4 sm:px-8 py-16 md:py-24 bg-white dark:bg-black dark:text-white text-2xl'>
    <div className='max-w-7xl mx-auto'>
        <h2 className='portfolio-section__heading text-6xl font-bold pb-16'>Projects</h2>
        ...
        <div className='flex flex-col md:flex-row gap-8 justify-between items-center pb-16 md:pb-24'>
            <div className='order-2 md:order-1 w-full md:w-1/2'>
                <h3 className='pb-6 font-bold text-4xl'>Portfolio V1</h3>
                <p className='pb-4 leading-9'><a className='underline underline-offset-4 decoration-dotted decoration-pink-300 hover:decoration-pink-800' href="https://sidneyhopkins.info/">2022. My first portfolio website</a> was built with Gatsby and React, and it includes a dynamic feature image from Nasa's Astronomy Photo of the Day API. Although I've improved since I built it in early 2022, it makes me happy to look back and see how much I've grown. So I keep it up.</p>
            </div>
            <img className='order-1 md:order-2 w-full md:w-2/5 block opacity-70' src='' alt='the homepage of my first portfolio'/>
        </div>

        <div className='flex flex-col md:flex-row gap-8 justify-between items-center'>
            <img className='w-full md:w-2/5 block opacity-70' src='' alt='the homepage of my first portfolio'/>                    
            <div className='w-full md:w-1/2'>
                <h3 className='pb-6 font-bold text-4xl'>Scribd Clone</h3>
                <p className='pb-4 leading-9'>2022. I made a <a className='underline underline-offset-4 decoration-dotted decoration-pink-300 hover:decoration-pink-800' href=" https://sidney-scribd-clone.netlify.app/">copy of the Scribd homepage</a> in 2022, using mostly React and Sass. Scribd has updated their prices and design since then, but the effect is the same.</p>
            </div>
        </div>
    </div>
</section>
